...
/**
 * Annotation to mark methods that require HALF_MODER permission level (2).
 * Methods annotated with this will automatically check for half moderator privileges.
 * 
 ...
 * - Admin users with permission level >= 2
 */
@Target(ElementType.METHOD)
@Retention(RetentionPolicy.RUNTIME)
public @interface RequireHalfMod {
} 